...
export const myProjects = [
	{
		...
		subdesc:
			"Developed using MongoDB, Express.js, React, and Node.js (MERN stack), with JWT for authentication. Backend deployed on Render.io and frontend on Vercel.",
	...
	},
	{
		...
		subdesc:
			"Built with React, utilizing hooks for state management and deployed on Vercel.",
	...
	},
	{
		...
		subdesc:
			"Developed using React with hooks for state management, featuring real-time updates and deployed on Vercel for optimal performance and accessibility.",
	...
	},
	{
		...
		subdesc:
			"Engineered with React, Three.js, React Three Fiber, and deployed on Netlify with optimized build processes.",
...
export const workExperiences = [
	{
		id: 1,
		name: "Polartir Technologies",
		pos: "Fullstack Developer",
		duration: "01/2024 - Present",
		title:
			"Developed Cometa Casino: professional crypto casino with real-time gameplay mechanics and WebSocket integration",
		techStack: "Next.js, NestJS, AWS, WebSockets, PostgreSQL",
		icon: "/assets/polartir-logo.png",
		animation: "victory",
	},
	{
		id: 2,
